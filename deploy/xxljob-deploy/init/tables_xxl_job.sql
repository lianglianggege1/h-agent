-- XXL-JOB 官方建表脚本（原版取自 xuxueli/xxl-job 3.4.1: doc/db/tables_xxl_job.sql）
-- 首次启动时由 MySQL 容器自动执行（挂载于 docker-entrypoint-initdb.d）
-- 库 xxl_job 由 MYSQL_DATABASE 预先创建，此处 IF NOT EXISTS 仅作兜底
