...
public interface HarnessRuntime {
    ...
    default Flux<AgentEvent> streamSubagent(
        ...
        return streamSubagent(agentBean, context, message, carrier, null);
    }
    ...
    default Flux<AgentEvent> streamSubagent(
        ...
        return streamSubagent(agentBean, context, message, null, approvalMode);
    }
    ...
    default Flux<AgentEvent> resumeSubagent(
        ...
        return resumeSubagent(agentBean, context, toolCallIds, approved, null);
    }
